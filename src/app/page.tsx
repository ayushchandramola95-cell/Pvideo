...
export const metadata: Metadata = {
  ...
  description: 'Stream and watch thousands of free porn videos, HD sex clips, and full length adult scenes. Browse our massive performer directory and popular categories.',
  alternates: {
    canonical: '/',
  },
};
